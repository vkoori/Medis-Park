...
use Modules\Product\Http\Resources\ComponentResource;
...
class ComponentController
{
    public function store(ComponentSaveRequest $request, ComponentService $productService)
    {
        ...
        return SuccessFacade::ok(data: ComponentResource::make($product));
    }
    ...
    public function index(ComponentFilterRequest $request, ComponentService $productService)
    {
        ...
        return SuccessFacade::ok(data: ComponentResource::collection($products));
    }
